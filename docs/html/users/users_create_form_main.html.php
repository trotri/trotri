...
<div class="form-group">
  <label class="col-lg-2 control-label">登录邮箱 *</label>
  <div class="col-lg-4">
    <input type="text" class="form-control input-sm">
  </div>
  <span class="control-label"></span>
...
<div class="form-group">
  <label class="col-lg-2 control-label">所属用户组</label>
  <div class="col-lg-4">
...
<div class="form-group">
  <label class="col-lg-2 control-label">已验证邮箱</label>
  <div class="col-lg-4">
...
<div class="form-group">
  <label class="col-lg-2 control-label">封禁</label>
  <div class="col-lg-4">
    <div id="label-switch" class="make-switch switch-small" data-on-label="是" data-off-label="否">
      <input type="checkbox">
    </div>
