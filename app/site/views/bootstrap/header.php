...
<?php echo $this->getHtml()->meta($this->system_meta_keywords, '', 'keywords'); ?>
<?php echo $this->getHtml()->meta($this->system_meta_description, '', 'description'); ?>
<?php echo $this->getHtml()->meta('', '', 'author'); ?>
<title><?php echo $this->system_meta_title; ?></title>
<!-- Bootstrap core CSS -->
