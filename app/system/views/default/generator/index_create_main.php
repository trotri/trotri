...
<div class="form-group">
  ...
  <div class="col-lg-4">
    <div id="label-switch" class="make-switch switch-small" data-on-label="是" data-off-label="否">
      <input type="checkbox" name="tbl_profile">
    </div>
  </div>
</div><!-- /.form-group -->
...
<div class="form-group">
  ...
  <label class="checkbox-inline">
    <input type="radio" class="icheck" name="tbl_engine">
  </label>
  <label class="checkbox-inline">MyISAM</label>
  <label class="checkbox-inline">
    <input type="radio" class="icheck" name="tbl_engine" checked>
  </label>
...
<div class="form-group">
  ...
  <label class="checkbox-inline">
    <input type="radio" class="icheck" name="tbl_charset" checked>
  </label>
  <label class="checkbox-inline">utf8</label>
  <label class="checkbox-inline">
    <input type="radio" class="icheck" name="tbl_charset">
  </label>
...
<div class="form-group">
  ...
  <label class="checkbox-inline">
    <input type="checkbox" class="icheck" name="index_row_btns[]" checked>
  </label>
  <label class="checkbox-inline">更新</label>
  <label class="checkbox-inline">
    <input type="checkbox" class="icheck" name="index_row_btns[]">
  </label>
