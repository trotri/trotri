...
/**
 * GcFileManager class file
 * 生成代码文件管理器
 * @author 宋欢 <trotri@yeah.net>
 * @version $Id: GcFileManager.php 1 2014-01-18 14:19:29Z huan.song $
...
class GcFileManager
{
	...
	{
		// 初始化工作开始
		Log::echoTrace('Initialization GcFileManager Begin ...');
		...
		// 初始化工作结束
		Log::echoTrace('Initialization GcFileManager End');
	}
