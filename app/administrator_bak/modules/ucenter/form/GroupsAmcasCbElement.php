...
/**
 * GroupsAmcasCbElement class file
 * 美化版Checkbox表单元素，，基于Bootstrap-v3前端开发框架的iCheck插件
 * @author 宋欢 <trotri@yeah.net>
 * @version $Id: GroupsAmcasCbElement.php 1 2013-05-18 14:58:59Z huan.song $
 * @package ui.bootstrap.form
 * @since 1.0
 */
class GroupsAmcasCbElement extends form\ICheckboxElement
{
	/**
	 * @var string 表单元素的类型
	 */
