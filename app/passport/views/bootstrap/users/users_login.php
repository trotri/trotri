...
<?php echo $this->getHtml()->openForm($this->getUrlManager()->getUrl($this->action), 'post', array('class' => 'form-signin')); ?>
  ...
  <?php echo $this->getHtml()->text('login_name', '', array('class' => 'form-control', 'placeholder' => $this->CFG_SYSTEM_GLOBAL_LOGIN_NAME, 'required', 'autofocus')); ?>
  ...
  <div class="checkbox"><label>
    <?php echo $this->getHtml()->checkbox('remember_me', 1, false); ?> <?php echo $this->CFG_SYSTEM_GLOBAL_REMEMBER_ME; ?>
  </label></div>
