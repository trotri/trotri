...
CREATE TABLE `#@__builder_field_groups` (
...
CREATE TABLE `#@__builder_field_validators` (
...
CREATE TABLE `#@__system_logwf_ym` (
...
CREATE TABLE `#@__users` (
  ...
  `ip_registered` int(10) NOT NULL DEFAULT '0' COMMENT '注册IP',
  `ip_last_login` int(10) NOT NULL DEFAULT '0' COMMENT '上次登录IP',
  `ip_last_repwd` int(10) NOT NULL DEFAULT '0' COMMENT '上次更新密码IP',
...
CREATE TABLE `#@__user_usergroups_map` (
...
CREATE TABLE `#@__post_categories` (
...
CREATE TABLE `#@__posts` (
  ...
  `dt_created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
  `dt_last_modified` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '上次编辑时间',
  `ip_created` int(10) NOT NULL DEFAULT '0' COMMENT '创建IP',
  `ip_last_modified` int(10) NOT NULL DEFAULT '0' COMMENT '上次编辑IP',
  `trash` enum('y','n') NOT NULL DEFAULT 'n' COMMENT '是否删除',
  PRIMARY KEY (`post_id`),
...
CREATE TABLE `#@__poll_member_logs` (
  ...
  `ip_last_modified` int(10) NOT NULL DEFAULT '0' COMMENT '上次投票IP',
  PRIMARY KEY (`log_id`),
