...
class Adverts extends AbstractDb
{
	...
	public function findAll(array $params = array(), $order = '', $limit = 0, $offset = 0)
	{
		...
		$sql = 'SELECT SQL_CALC_FOUND_ROWS `advert_id`, `advert_name`, `type_key`, `description`, `is_published`, `dt_publish_up`, `dt_publish_down`, `sort`, `show_type`, `show_code`, `title`, `advert_url`, `advert_src`, `advert_src2`, `attr_alt`, `attr_width`, `attr_height`, `attr_fontsize`, `attr_target`, `dt_created` FROM `' . $tableName . '`';
