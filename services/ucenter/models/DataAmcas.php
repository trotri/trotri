...
class DataAmcas
{
	...
	public static function getCategoryEnum()
	{
		...
		if ($enum === null) {
			$enum = array(
				self::CATEGORY_APP => Lang::_('MOD_ENUM_USER_AMCAS_CATEGORY_APP'),
				self::CATEGORY_MOD => Lang::_('MOD_ENUM_USER_AMCAS_CATEGORY_MOD'),
				self::CATEGORY_CTRL => Lang::_('MOD_ENUM_USER_AMCAS_CATEGORY_CTRL'),
				self::CATEGORY_ACT => Lang::_('MOD_ENUM_USER_AMCAS_CATEGORY_ACT'),
			);
		}
